...
modifications:
- cheats now last > 20 picoseconds

- still the same: find cheats that will save > 100 seconds


is it possible to still dynamically generate cheats with > 20 paths? keep in mind that all the subpaths in between are also cheats...
 */
using namespace std;
